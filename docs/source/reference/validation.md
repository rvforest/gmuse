...
For step-by-step fixes, examples, and guidance on how to adjust prompts or use `--hint` to guide the model toward a valid message, see the [Troubleshooting guide — Validation failures](../how_to/troubleshooting.md#validation-failures).

                ...
                def run_side_effect(*args, **kwargs):
                    ...
                    if "diff" in cmd and "--cached" in cmd:
                        ...
                        if "--abbrev-ref" in cmd:
                            return mock.Mock(
                                returncode=0, stdout="feature/add-auth\n", stderr=""
                            )
    ...
    def test_branch_sanitization_in_context(self) -> None:
        ...
        with mock.patch("gmuse.git.is_git_repository", return_value=True):
            with mock.patch("subprocess.run") as mock_run:
                ...
                def run_side_effect(*args, **kwargs):
                    ...
                    if "diff" in cmd and "--cached" in cmd:
                        ...
                        if "--abbrev-ref" in cmd:
                            ...
                            return mock.Mock(
                                returncode=0,
                                stdout="fix/PROJ-123-bug-in-api\n",
                                stderr="",
                            )
                        return mock.Mock(returncode=0, stdout="/repo\n", stderr="")
                    return mock.Mock(returncode=0, stdout="", stderr="")
                ...
                assert isinstance(context.branch_info.branch_summary, str)
            ...
            with mock.patch("subprocess.run") as mock_run:
                ...
                def run_side_effect(*args, **kwargs):
                    ...
                    if "diff" in cmd and "--cached" in cmd:
                        ...
                        if "--abbrev-ref" in cmd:
                            return mock.Mock(
                                returncode=0, stdout=f"{long_branch}\n", stderr=""
                            )
                        return mock.Mock(returncode=0, stdout="/repo\n", stderr="")
                    return mock.Mock(returncode=0, stdout="", stderr="")
